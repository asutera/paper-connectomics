...
From the pre-processing to the weighted averaging of partial correlation
matrix, all pre-processing and post-processing is useful to improve score
...
\caption{The weighted average of partial correlation matrix, winning approach
         ...
         averaging method, partial correlation used filter $f_1$).}
\label{fig:curves}
\end{figure}
