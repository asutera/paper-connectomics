...
\jmlryear{2014}
\jmlrworkshop{Neural Connectomics Workshop: From Imaging to Connectivity}
...
GENIE3 &\\
\end{tabular}
\caption{Top: ROC (left) and PR (right) AUC on \text{normal-1,2,3,4} with partial correlation and different filtering functions except the last two rows with an average over various parameter settings.
