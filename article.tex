...
active state.  Finally, the difficulty to distinguish direct relationships when there is a network burst, defined as a highly synchronous activity [Stetter and in Stetter [20,46,47]], is increased by the slow sampling rate.
