...
\begin{table}[htb]
\centering
\caption{Correlation. Improvement of each stage of our approach. Note that we choose the
         \textit{best} threshold (\textcolor{red}{for now 0.11}) for stages 1 to 4.}
\begin{tabular}{*{5}{l}}
\toprule
Stage               & normal-1 & normal-2 & normal-3 & normal-4 \\
\midrule
Nothing             & 0.681 (0.028) & & & \\
hard-threshold      & 0.876 (0.143) & & & \\
Pre-processing      & 0.857 (0.100) & & & \\
PCA                 & & & & \\
Weighting           & 0.826 (0.079) & & & \\
Averaging           & & & & \\
\bottomrule
\end{tabular}
\end{table}
