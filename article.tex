...
and about 12000 edges each (i.e., a network density of about
1.2\%). Each neuron is described by a calcium fluorescence time series
...
severely affects the performance of this method with respect to the use of fully
...
network inference methods while its optimized version proved to be best method
