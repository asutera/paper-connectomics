...
The raw signal is the calcium fluorescence imaging representing neuron activity. Considering the imaging process, we have to cope with a slower sampling rate than the neuron firing frequency and the slow decay of fluorescent calcium indicator after a neuron activity burst.
