...
\begin{description}
\item[GTE], the baseline of the challenge, measures for all pairs of
...
\item[GENIE3] (\cite{huynhthu2010inferring}) translates the inference of the
...
random forest (\cite{breiman2001random}). The tree ensemble associate a
variable importance scores (\cite{louppe2013understanding})
