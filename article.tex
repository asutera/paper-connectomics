...
% comparison. Then, on Table \ref{tab:tab3}, our approach is decomposed to show
% the contribution of each pre-processing steps. Afterwards, we will perform a comparison
% between several methods on Figure \ref{fig:curves} and Table \ref{tab:tab1}. Note that two
