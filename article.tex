...
\subfigure[Global regularization $w$]{\includegraphics[width=0.3\textwidth]{images/weights_curve.pdf} \label{fig:original_curve}}
...
difficult task. Furthermore, it is even possible that neurons spike because of
a global high activity, without any actual cause (see \cite{stetter2012model}).
...
neurons, thereby reducing the importance of peaks identified during global
