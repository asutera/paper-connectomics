...
% Introduce notation
Let us denote the $n$ time step of fluorescent calcium time series from $p$
neurons by $X \in \mathcal{R}^{n \times p}$ and by
$y \in \left\{0, 1 \right\}^{p \times p}$ the network connectivity graph, where
