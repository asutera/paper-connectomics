...
weights (i.e., resp. $1$ and $0.9$). Additionally, these weights were chosen equal as the weights selected for the simplified method. In contrast, filters $f_3$
and $f_4$ turn out to be individually less competitive and were therefore given
smaller weights in the tuned averaging (i.e., resp. $0.01$ and $0.7$). Yet, as further shown in
