...
well-known that neurons may also spike because of a global high activity (see
\cite{stetter2012model}). In such  context, detecting pairwise neuron
...
global activity. Note that the particular case where $\sum_{j} x^{t}_j = 0$ is
solved by setting $w(x^{t}_i) = 1$.
