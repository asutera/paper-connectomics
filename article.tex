...
The raw signal is the calcium fluorescence imaging representing
...
As it can be seen on \textit{fig 1}, the raw signal is very noisy and
...
$ X_{t,w}^i  = (x^{t,d}_i + 1 )^{1 + \frac{1}{\sum_{j} X_{t,d}^j}} $.
