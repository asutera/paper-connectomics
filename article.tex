...
<<<<<<< HEAD
other methods (see Table \ref{tab:comparison} and Appendix \ref{app:supp}). The improvement is more important in terms of AUPRC than in
=======
other methods. The improvement is more important in terms of AUPRC than in
>>>>>>> 617052848a2569cd038be4f4cfe37a4300ba2ecc
...
weights (i.e., resp. $0.383$ and $0.345$). These weights were chosen equal as the weights selected for the simplified method. In contrast, filters $f_3$
