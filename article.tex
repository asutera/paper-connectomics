...
This appendix is structured as follows: Section \ref{app:signal} describes the differences about the signal processing methods applied on fluorescent calcium time series; Section \ref{app:averaging} then provides a detailed explanation of the averaging approach; Section \ref{app:connectome} presents a heuristic trying to retrieve directivity from fluorescent calcium time series while Section \ref{app:results} finally present results validating some choices that have been made.
