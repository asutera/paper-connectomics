...
The fluorescent calcium image delivers at each acquisition a 2-D view of the
neuron network activities. However, some neurons might not observed or are
confounded with others. The low device sampling rate with respect to neuronal
activity speed might not allow to distinguish neuron activation order,
especially in highly synchronous activity [Stetter and in Stetter [20,46,47]]
of a large part of the network. Moreover the fluorescent concentration is
highly reactive to a neuron activation or a spike, but have a slow decay.
...
\includegraphics[width=\linewidth]{images/fig_filtering.pdf}
\end{figure}
