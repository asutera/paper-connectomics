...
% To perform experiments, we used a Macbook Pro (2014) with a ram memory 16Go 1600 MHz DDR3 and a processor 2.3GHz Intel Core i7.

% In order to compare the execution time with other methods, it takes about xx and xx hours to compute respectively GTE and GENIE3. However, GENIE3 is highly parallelizable (by taking several smaller forests or applying GENIE3 on subsets of variables) and the execution time can be significantly reduced. 
...
% Methods & Execution time  & Memory requirements \\ \hline
% PC & & $\sim$5Go\\
% Averaging & & \\
% Full Method & & \\ \hline
% \end{tabular}
