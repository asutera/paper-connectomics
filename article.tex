...
filters gets better \textcolor{red}{AS:Does it necessary to show it numerically?}.
...
\hline
& \multicolumn{4}{c|}{AUROC} & \multicolumn{4}{c|}{AUPRC} \\
\textit{Method} $\backslash$ \textit{normal-} & \textit{lowcon} & \textit{highcon} & \textit{lowcc} & \textit{highcc} & \textit{normal-3-highrate} & \textit{normal-4-lownoise} & \textit{1} & \textit{2} & \textit{3} & \textit{4} & \textit{normal-3-highrate} & \textit{normal-4-lownoise}\\
\hline
\hline
% No  filtering       					& 0.777 & 0.767 & 0.772 & 0.774 & 0.070 & 0.064 & 0.068 & 0.072\\
% $ h \circ g \circ f_1$                  & 0.923 & 0.925 & 0.923 & 0.922 & 0.311 & 0.315 & 0.313 & 0.304\\
