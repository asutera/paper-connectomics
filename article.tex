...
Challenge\footnote{\url{http://connectomics.chalearn.org}}, a simple and
theoretically grounded approach based on signal processing techniques and
partial correlation statistics to infer the neural network. The rest of the
...
\midrule
GENIE3 (depth = 1)     & 0.890 & & & & 0.236 & & & \\
GENIE3 (depth = 2)     & 0.895 & & & & 0.269 & & & \\
GENIE3 (depth = 3)     & & & & & & & & \\
