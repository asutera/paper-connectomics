...
Formally, the unsupervised may be formulated as :
...
infer the connectivity network $y \in \left\{0, 1\right\}^{p \times p}$ where
non zero values indicate that the neuron $i$ have an outward connection to
the neuron $j$.}

From a probabilistic point of view, the newtwork
