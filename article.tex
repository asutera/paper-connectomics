...
other   variables   $X^{-i,j}$   if  their   \textit{partial   correlation}
statistic is null~\citep{baba2004partial}, i.e., if
\begin{equation}
...
the data. The partial correlation statistics is computed through the inverse
