...
is to distinguish direct from indirect interactions [de la Fuente et al., 2004].
...
variables. In previous studies [Shipley, 2002], it has been suggested
consider correlation coefficients of all possible orders [Shipley, 2002],
...
both [de la Fuente, 2004]). Furthermore two other causal mechanisms may be implied
...
%      specify f_1 and f_2
Some causal information (directivity of the links) were retrieved from the
