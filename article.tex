...
\textcolor{red}{AJ: It's not clear on which datset we focus on}
...
Two reasons might explain such differences: (i) among
...
\begin{figure}[bth]
\centering
\subfigure[]{\includegraphics[width=0.45\textwidth]{images/curve_roc} \label{fig:roc_curve}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{images/curve_pr} \label{fig:pr_curve}}
\caption{The weighted average of partial correlation matrix, winning approach
         ...
         averaging method, partial correlation used filer $f_1$).}
\label{fig:curves}
\end{figure}
